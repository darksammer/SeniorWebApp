# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-03-09 16:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='period_fk', to='valuation.Dividend_Payout')),
            ],
        ),
        migrations.CreateModel(
